                ...
                <div id="wrap_bg">
                    <div id="carousel-example-generic" className="carousel slide" data-ride="carousel">
                        ...
                        <div className="carousel-inner" role="listbox">
                            ...
                            <div className="item">
                                <img
                                    src="https://ss0.bdstatic.com/70cFuHSh_Q1YnxGkpoWK1HF6hhy/it/u=3767928281,3855971241&fm=23&gp=0.jpg"
                                    width="400px" alt="星空3"/>
                                <div className="carousel-caption">
                                    标题5
                                </div>
                            ...
                            <div className="item">
                                <img
                                    src="https://ss3.bdstatic.com/70cFv8Sh_Q1YnxGkpoWK1HF6hhy/it/u=1479944402,3829552589&fm=23&gp=0.jpg"
                                    alt="星空2"/>
                                <div className="carousel-caption">
                                    标题6
                                </div>
